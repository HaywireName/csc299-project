...
def get_tips():
    ...
    return [
        ...
        "The 'agent' module can analyze your tasks and find connections",
        "Chat context modes: 'general', 'tasks', 'pdfs', or 'all' for everything",
        ...
        "Type module names directly: 'tasks', 'docs', 'chat', 'agent', 'settings'",
        "The 'synthesize' command creates insights from tasks and documents",
